...
<div class="wrapper">
    <div class="main">
        <div class="header-logos">
            <div class="ett-logo">
                <img src="${data.EttLogoSrc}" alt="logo">
            </div>
            <div class="ppl-logo">
                <img src="${data.CustomerLogoSrc}" alt="logo">
            </div>
        </div>
        <div class="header-texts">
            <div class="header-date text-xs-light-grey">Issued ${data.Issued} by ETT Solutions</div>
            <div class="header-code text-xs-bold">${data.Code}</div>
        </div>
        <div class="row">
            <div>
                ...
                <div class="guestList">
                    <div class="guestListItem">
                        ...
                        <div>
                            <div class="guest-value text-sm-bold">${data.VisitDate}</div>
                        </div>
                    </div>
                    <div class="guestListItem">
                        <div class="label text-sm-grey">STAY DURATION </div>
                        <div class="guest-value text-sm-bold">${data.StayDuration}</div>
                    </div>
                    <div class="guestListItem">
            ...
            <div class="border">
                <img src="${data.QrCodeSrc}"  alt="qr_code"/>
            </div>
        </div>
        <div class="guestLastItem">
            <div class="label text-sm-grey">GUEST NAME</div>
            <div class="guest-value text-sm-bold"> ${data.GuestName} </div>
        </div>
        ...
        <div class="loungeList">
            <div class="loungeListItem">
                ...
                <div class="value text-sm-bold">${data.Name}</div>
            </div>
            <div class="loungeListItem">
                <div class="label text-sm-grey">AIRPORT</div>
                <div class="value text-sm-bold">${data.Airport}</div>
            </div>
            <div class="loungeListItem">
                <div class="label text-sm-grey">TERMINAL</div>
                <div class="value text-sm-bold">${data.Terminal}</div>
            </div>
            <div class="loungeListItem">
                <div class="label text-sm-grey">CITY</div>
                <div class="value text-sm-bold">${data.City}</div>
            </div>
            <div class="loungeListItem location">
                <div class="label text-sm-grey">LOCATION</div>
                <div class="value text-sm-bold">${data.Location}</div>
            </div>
            <div class="loungeListItem last">
                <div class="label text-sm-grey">OPEN HOURS</div>
                <div class="value text-sm-bold">${data.OpenHours}</div>
            </div>
        </div>
...
function servicesHtml(){
    return `<div class="servicItem text-xs-white">
    <i class=""></i>
    <text class="service">{service.Name}</text>
</div><div class="servicItem text-xs-white">
    <i class=""></i>
    <text class="service">{service.Name}</text>
</div><div class="servicItem text-xs-white">
    <i class=""></i>
